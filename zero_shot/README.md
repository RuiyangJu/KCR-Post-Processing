...
```
  ...
  python ./evaluate.py --gt_dir ./dataset/gt --pred_dir ./Llama-3-ELYZA-JP-8B/output --out_csv ./Llama-3-ELYZA-JP-8B/output_csv
```
...
```
  ...
  python ./evaluate.py --gt_dir ./dataset/gt --pred_dir ./Llama-3-Youko-8B-Instruct/output --out_csv ./Llama-3-Youko-8B-Instruct/output_csv
```
...
```
  ...
  python ./evaluate.py --gt_dir ./dataset/gt --pred_dir ./Llama-3.1-Swallow-8B-Instruct-v0.3/output --out_csv ./Llama-3.1-Swallow-8B-Instruct-v0.3/output_csv
```
...
```
  ...
  python ./evaluate.py --gt_dir ./dataset/gt --pred_dir ./RakutenAI-7B-Instruct/output --out_csv ./RakutenAI-7B-Instruct/output_csv
```
...
```
  ...
  python ./evaluate.py --gt_dir ./dataset/gt --pred_dir ./Gemma-2-Llama-Swallow-9b-it-v0.1/output --out_csv ./Gemma-2-Llama-Swallow-9b-it-v0.1/output_csv
```
...
```
  ...
  python ./evaluate.py --gt_dir ./dataset/gt --pred_dir ./Qwen3-Swallow-8B-RL-v0.2/output --out_csv ./Qwen3-Swallow-8B-RL-v0.2/output_csv
```
...
```
  ...
  python ./evaluate.py --gt_dir ./dataset/gt --pred_dir ./LLM-jp-4-8B-Instruct/output --out_csv ./LLM-jp-4-8B-Instruct/output_csv
```
